...
st.markdown("""
The U-Net neural network analyzes the image and identifies potential barnacles. 
...
This prototype brings together automation and expert knowledge, integrates into scientific workflows, scales to other marine biology applications, and offers time savings for ecological research.
""")
